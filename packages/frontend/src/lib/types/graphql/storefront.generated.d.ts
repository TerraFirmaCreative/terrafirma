...
export type GetLocalizadBannerQuery = {
  localization: {
    market: (
...
export type SearchPredictionsQuery = {
  predictiveSearch?: StorefrontTypes.Maybe<{
    queries: Array<Pick<StorefrontTypes.SearchQuerySuggestion, 'text' | 'styledText'>>, products: Array<(
...
export type SearchPaginatedProductsQuery = {
  search: {
    edges: Array<(
...
export type RandomProductsQuery = {
  products: {
    edges: Array<(
...
export type CreateCartMutation = {
  cartCreate?: StorefrontTypes.Maybe<{
    cart?: StorefrontTypes.Maybe<(
      ...
      & {
        cost: { totalAmount: Pick<StorefrontTypes.MoneyV2, 'amount' | 'currencyCode'> }, lines: {
          edges: Array<{
            node: (
