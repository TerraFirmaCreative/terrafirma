...
import { PaginatedProductsQuery, ProductSortKeys, SearchSortKeys } from "@/lib/types/graphql"
  ...
  return (
    <>
      ...
      <section className="ml-60 ">
        ...
        <div className="p-16 grid grid-cols-[repeat(auto-fill,250px)] justify-start grid-flow-row-dense w-full gap-6 h-full overflow-scroll">
